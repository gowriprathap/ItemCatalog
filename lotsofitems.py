...
from database_setup import Category, Base, Item, User #importing tables from database_setup.py

engine = create_engine('sqlite:///itemcatalog.db') # connecting to the database
...
# Menu for guitar
category1 = Category(name="Guitar") # adding the first category guitar
session.add(category1)
session.commit() # commit to the session
...
print("Instruments added!") # printing to the terminal to confirm that the Instruments have been added
